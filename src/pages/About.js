...
const About = () => {
    return (
        <>
            ...
            <br/>
            <br/>
            Through our website, we strive to showcase the best that Egypt has to offer. We provide comprehensive guides to the country's most famous historical sites, including the Pyramids of Giza, Luxor Temple, and Abu Simbel. Additionally, we offer insights into lesser-known hidden gems and off-the-beaten-track destinations that are equally fascinating.
            <br/>
            <br/>
            Whether you're interested in exploring ancient history, relaxing on the beach, or immersing yourself in local culture, our website is the perfect guide to help you plan your next adventure. Join us as we explore Egypt's fascinating past, vibrant present, and exciting future.</p>
        </>
    )
}
